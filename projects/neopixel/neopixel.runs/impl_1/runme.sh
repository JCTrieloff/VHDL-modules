...
HD_PWD='/home/jtrieloff/cern/Xilinx/Vivado/2019.2/VHDL-modules/projects/neopixel/neopixel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Head.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Head.tcl -notrace
