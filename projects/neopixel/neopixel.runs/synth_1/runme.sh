...
HD_PWD='/home/jtrieloff/cern/Xilinx/Vivado/2019.2/VHDL-modules/projects/neopixel/neopixel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Head.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Head.tcl
